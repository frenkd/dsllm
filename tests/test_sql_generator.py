...
class TestSQLGenerator:
    ...
    def test_read_only_system_prompt(self) -> None:
    ...
    def test_syntax_validation_valid_sql(self) -> None:
    ...
    def test_syntax_validation_invalid_sql(self) -> None:
    ...
    def test_pre_flight_check_valid(self) -> None:
    ...
    def test_pre_flight_check_empty_input(self) -> None:
    ...
    def test_pre_flight_check_read_only_warning(self) -> None:
